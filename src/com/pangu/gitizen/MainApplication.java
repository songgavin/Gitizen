...
import com.pangu.gitizen.fragment.ProfileFragment;
...
//        menu.findItem(R.id.action_websearch).setVisible(!drawerOpen);
    ...
    private void selectItem(int position) {
        ...
        if(position == 1) {
        	Fragment fragment = new EventcenterFragment();
	        Bundle args = new Bundle();
	        args.putInt(EventcenterFragment.ARG_PLANET_NUMBER, position);
        	...
        	Bundle args = new Bundle();
	        args.putInt(HistoryFragment.ARG_PLANET_NUMBER, position);
	        fragment.setArguments(args);
	        ...
	        Bundle args = new Bundle();
	        args.putInt(CategoryFragment.ARG_PLANET_NUMBER, position);
	        fragment.setArguments(args);
